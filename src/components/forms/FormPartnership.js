  ...
  return (
    <div className="container d-flex justify-content-center">
      <div className="col-xxl-8 px-4 py-5">
        <div className="card bg-success row flex-lg-row-reverse  py-5">
          ...
          <div className="col-lg-6 text-center" bis_skin_checked="1">
            ...
            >
              ...
              <div className="text-center mb-2 d-grid mx-3 pt-3">
                <Button type="submit" className="button btn-outline-warning fw-bold" size="lg">
                  Send Request
                </Button>
                ...
                <Link to="/register" className="link-width w-100">
                  <Button className="button btn-warning text-light fw-bold w-100" size="lg">
                    Register
                  </Button>
                </Link>
              </div>
