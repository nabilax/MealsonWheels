    ...
    <Layout>
      <div className="terms">
        <div className="container">
          ...
          <div className="terms-detail pb-5">
            <p>
              Welcome to mealsonwheels!
              <br />
              These terms and conditions outline the rules and regulations for
              the use of Meals on Wheels's Website, located at
              mealsonwheels.com.
              <br />
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use mealsonwheels if you do not
              ...
              Cookies
              <br />
              We employ the use of cookies. By accessing mealsonwheels, you
              ...
              <br />
              <ul>
                <li>Republish material from mealsonwheels</li>
                <li>Sell, rent or sub-license material from mealsonwheels</li>
                <li>
                  Reproduce, duplicate or copy material from mealsonwheels
                </li>
                <li>Redistribute content from mealsonwheels</li>
              </ul>
