          ...
          <Col sm={12}>
            <div className="card bg-success">
              <div className="text-center">
                <h3 className="text-white py-3">Rider Profile</h3>
              </div>
              <Row className="mb-3">
                <Col>
                  <img
              ...
              <tbody className="text-white">
                {orderList.map((order, index) => (
                  <tr key={index}>
                    ...
                    <td className="text-success w-25">{order.preparedBy.address}</td>
                    <td className="text-success w-25">{order.orderBy.address}</td>
                    <td className="text-success w-25">
                      <div className="status success-white d-flex justify-content-center">
